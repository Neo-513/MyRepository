...
class BiliBili:
	...
	def get_favs(self, fid):
		...
		items = map(lambda x: x["data"]["medias"], map(mu.jsn2dic, datas))
	...
	def get_uname(self, mid):
		...
		return mu.jsn2dic(data)["data"]["name"]
